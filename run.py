...
if __name__ == '__main__':
    ...
    if args.pretrain:
        ...
        compgcn_model.fit()
        lightgcn = LightGCNEngine(args, device=device, pretrain_embs=(compgcn_model.user_embed, compgcn_model.item_embed), ent2id=compgcn_model.ent2id, user2id=compgcn_model.user2id)
    else:
